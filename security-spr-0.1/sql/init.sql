...
INSERT INTO monapp.users (id,login, password, firstName, lastName, mail,citizenShip, spokenLanguages, dateOfBirth) VALUES
  ...
  (2,'admin', '123456','vfdv', 'vfd', 'leo.vfd@toncul.com', 'français', 'anglais; français', '05/04/1989' ),
  (3,'utilisateur1', '123456', 'vfdv', 'vfd', 'leo.vfd@toncul.com', 'français', 'anglais; français', '05/04/1989');
