...
<a href="${pageContext.request.contextPath}/admin/administration.html">Administration</a><br/>
<a href="${pageContext.request.contextPath}/user/info.html">Connectez vous</a><br/>
<a href="/inscription.html">Inscrivez vous!</a><br/>
